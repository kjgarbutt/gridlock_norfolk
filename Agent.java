...
//    }
    ...
    public Agent(Gridlock_Norfolk g, String home, String work,
     ...
     */
    public boolean start(Gridlock_Norfolk state)
    {
    ...
    private void findNewAStarPath(Gridlock_Norfolk geoTest)
    {
    ...
    public void step(SimState state)
    {
        ...
        boolean toWork = ((Gridlock_Norfolk) state).goToWork;
